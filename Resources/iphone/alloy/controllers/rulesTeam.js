...
function Controller() {
    ...
    this.__controllerPath = "rulesTeam";
    if (arguments[0]) {
        {
    ...
    $.__views.rulesTeam = Ti.UI.createWindow({
        id: "rulesTeam",
        backgroundImage: "/images/background/rules_team.jpg"
    });
    ...
    _.extend($, $.__views);
    $.rulesTeam.backgroundImage = "AR" == Alloy.Globals.subsidiaryCode ? "/images/background/AR/rules_team.png" : "/images/background/MX/rules_team.jpg";
